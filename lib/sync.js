  ...
  try{
    ...
    if(googleConfigured()&&googleToken){
      try{
        ...
        const calendarRefreshStarted=new Date();
        ...
        if(googleData.calendarAvailable){
          await db().query("delete from records where source='calendar' and updated_at < $1",[calendarRefreshStarted]);
        }
        ...
        summary.google={
          ...
          calendarAvailable:Boolean(googleData.calendarAvailable),
