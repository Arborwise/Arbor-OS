const CACHE='arborwise-os-v13';
const CORE=['/','/index.html','/app.css?v=13','/app.js?v=12','/manifest.webmanifest','/assets/annie-icon-192.png','/assets/annie-icon-512.png','/assets/arborwise-logo.png','/assets/annie-main-icon.png'];
