const CACHE='arborwise-os-v16';
const CORE=['/','/index.html','/app.css?v=16','/app.js?v=16','/operational-overrides.js?v=16','/manifest.webmanifest','/assets/annie-icon-192.png','/assets/annie-icon-512.png','/assets/arborwise-logo.png?v=16','/assets/annie-main-icon.png'];
