...
(() => {
  ...
  const updatedAt = '2026-07-23T18:21:53-05:00';
  ...
  const records = [
    ...
    {id:'2011',type:'job',name:'Sicily Laguna Azure',address:'2902 Cremini Falls, Princeton, TX',phone:'972-707-4862',service:'Remove and replace tree; secure replacement tree and install mulch; haul off debris.',amount:866,category:'SBB',who:'Unassigned',status:'Hold',workDate:'',workTime:'',notes:'Hold — no tree is present now, but the prior tree location is visible. Typical scope is remove and replace. Verify before scheduling. Operations oversight: Greg.',closed:false,completionType:null,laborCost:null,oversight:'Greg'},
    ...
    {id:'2013',type:'job',name:'Sicily Laguna Azure',address:'3016 Isla Terrace, Princeton, TX',phone:'972-707-4862',service:'Remove and replace tree; secure replacement tree and install mulch; haul off debris.',amount:866,category:'SBB',who:'Unassigned',status:'Hold',workDate:'',workTime:'',notes:'Hold — homeowner replacement is unconfirmed. Do not schedule or count as completed until verified. Tree and material allocation remains pending final reconciliation. Operations oversight: Greg.',closed:false,completionType:null,laborCost:null,otherCost:280.13,oversight:'Greg'},
    ...
    {id:'1977',type:'job',name:'Dana & Tom Pierson',address:'9905 County Road 626, Blue Ridge, TX 75424',phone:'214-901-5732',service:'Full-day personalized tree care, hackberry removal, live oak clearance, pruning, balance and elevation.',amount:2706.25,category:'RESIDENTIAL',who:'Scheduling: Brandon',status:'Accepted',workDate:'',workTime:'',notes:'Accepted estimate. Scheduling pending; no date, arrival window, or field crew assigned. Brandon owns scheduling follow-up. Operations oversight: Greg.',closed:false,oversight:'Greg'},
  ...
  state = {...state, records:[...byId.values()], currentOperationsUpdatedAt:updatedAt, currentSnapshotVersion:53, live:false, lastSync:updatedAt};
