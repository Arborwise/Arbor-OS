...
(() => {
  ...
  function greet(){
    if(greeted||sessionStorage.getItem('arborwise-annie-greeted-v58'))return;
    greeted=true;
    sessionStorage.setItem('arborwise-annie-greeted-v58','1');
  ...
  window.ARBORWISE_ANNIE_VERSION='58';
})();
