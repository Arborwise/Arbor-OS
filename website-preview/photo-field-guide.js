(() => {
  ...
  const enabledCities = new Set(['Farmersville', 'Anna', 'Melissa', 'Celina', 'Van Alstyne']);
    ...
    <div class="photo-guide-group">
      ...
      <div class="photo-guide-grid good-grid">
        <figure class="photo-card wide">
          <img src="/assets/photo-guide/selective-pruning.webp" alt="Arborwise climber positioned in a mature canopy for selective pruning" loading="lazy">
        ...
        <figure class="photo-card wide">
          <img src="/assets/photo-guide/controlled-removal.webp" alt="Arborwise crew controlling a tree removal near homes and fences" loading="lazy">
        ...
        <figure class="photo-card">
          <div class="photo-sprite sprite-healthy" role="img" aria-label="Healthy young tree with a full green canopy and visible trunk"></div>
    ...
    <div class="photo-guide-group">
      ...
      <div class="photo-guide-grid concern-grid">
        <figure class="photo-card volcano">
          <div class="photo-sprite sprite-volcano" role="img" aria-label="Mulch piled high against the trunk of a young tree"></div>
        ...
        <figure class="photo-card">
          <div class="photo-sprite sprite-roots" role="img" aria-label="Large surface roots constrained by a small hard tree ring"></div>
        ...
        <figure class="photo-card">
          <div class="photo-sprite sprite-leaf" role="img" aria-label="Tree canopy with pale, curled, and discolored leaves"></div>
        ...
        <figure class="photo-card">
          <div class="photo-sprite sprite-dead" role="img" aria-label="Tree canopy with dead tips and sparse foliage"></div>
        ...
        <figure class="photo-card">
          <div class="photo-sprite sprite-cavity" role="img" aria-label="Large open trunk wound and cavity near the base of a mature tree"></div>
    ...
    <div class="photo-games">
      <article class="photo-game annie-game">
        ...
        <div class="game-image">
          <img src="/assets/photo-guide/wheres-annie.webp" alt="Busy illustrated forest scene containing a hidden Annie owl" loading="lazy">
      ...
      <article class="photo-game climber-game">
        ...
        <div class="game-image">
          <img src="/assets/photo-guide/hidden-climber.webp" alt="Arborwise climber partly hidden in a leafy canopy" loading="lazy">
  ...
  style.textContent = `
    ...
    .photo-guide-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:15px}.photo-card{margin:0;background:white;border:1px solid var(--line);border-radius:24px;overflow:hidden;box-shadow:0 10px 28px rgba(18,63,47,.07)}.photo-card img,.photo-sprite{width:100%;height:260px;object-fit:cover}.photo-sprite{background-image:url('/assets/photo-guide/field-guide-sprite.webp');background-size:300% 200%;background-repeat:no-repeat;background-color:#e8eee5}.sprite-healthy{background-position:0 0}.sprite-volcano{background-position:50% 0}.sprite-roots{background-position:100% 0}.sprite-leaf{background-position:0 100%}.sprite-dead{background-position:50% 100%}.sprite-cavity{background-position:100% 100%}.photo-card figcaption{padding:18px 19px 21px}.photo-card strong{display:block;font-family:var(--serif);font-size:1.2rem;color:var(--forest);margin-bottom:6px}.photo-card span{display:block;color:var(--muted);font-size:.91rem;line-height:1.45}.good-grid .wide{grid-column:span 1}
    ...
    @media(max-width:650px){.photo-field-guide{padding:48px 13px;margin-bottom:55px}.photo-guide-heading{text-align:center}.photo-guide-grid{grid-template-columns:1fr}.photo-card img,.photo-sprite{height:280px}.photo-guide-label{display:flex;width:max-content;margin-left:auto;margin-right:auto}.photo-guide-cta{display:block;text-align:center}.photo-guide-cta a{display:inline-flex;margin-top:13px}.game-copy{text-align:center}.game-marker{width:34px;height:34px}}
  `;
