(() => {
  ...
  style.textContent = `
    ...
    .annie-callout.aw-annie-section{
    ...
    .aw-annie-trunk-mask{
      ...
      background:
        ...
        linear-gradient(92deg,
          transparent 0 12%,rgba(19,7,3,.9) 13% 20%,transparent 21% 36%,
          rgba(51,24,12,.78) 37% 44%,transparent 45% 61%,
          rgba(20,7,3,.88) 62% 70%,transparent 71% 84%,
          rgba(59,29,15,.72) 85% 92%,transparent 93% 100%),
        linear-gradient(88deg,
          rgba(238,191,136,.08) 0 10%,transparent 11% 28%,
          rgba(245,204,153,.09) 29% 36%,transparent 37% 56%,
          rgba(231,178,122,.07) 57% 64%,transparent 65% 100%),
    ...
    .aw-annie-edge.left{
      left:0;
      clip-path:polygon(0 0,78% 0,91% 8%,72% 18%,96% 29%,74% 40%,89% 52%,69% 64%,95% 76%,73% 88%,87% 100%,0 100%);
    }
    .aw-annie-edge.right{
      right:0;
      clip-path:polygon(22% 0,100% 0,100% 100%,14% 100%,27% 88%,6% 76%,31% 64%,11% 52%,25% 40%,5% 29%,29% 18%,10% 8%);
    }
    ...
    .aw-annie-guide.right{right:0}
    .aw-annie-guide.left{left:0}
    ...
    .aw-annie-button.blink::after{
      ...
      border-radius:50%;
      background:#efd9aa;
      border-bottom:2px solid #3a2116;
      animation:awAnnieBlink .38s ease-in-out 1;
    }
    ...
    .aw-annie-bubble{
      ...
      letter-spacing:-.01em;
      text-align:center;
      box-shadow:2px 3px 0 rgba(18,45,35,.13),0 6px 14px rgba(15,48,37,.12);
      opacity:0;
    ...
    .aw-annie-bubble.long{width:148px;min-height:48px;padding:8px 11px;font-size:10.1px}
    .aw-annie-bubble.show{opacity:1;transform:none}
    .aw-annie-guide.right .aw-annie-bubble{right:7px}
    .aw-annie-guide.left .aw-annie-bubble{left:7px}
    ...
    .aw-annie-guide.right .aw-annie-bubble::before{
      right:32px;
      bottom:-20px;
      border-left:9px solid transparent;
      border-right:3px solid transparent;
      border-top:20px solid #153c30;
      transform:rotate(-8deg);
      transform-origin:top center;
    }
    .aw-annie-guide.right .aw-annie-bubble::after{
      right:33px;
      bottom:-15px;
      border-left:7px solid transparent;
      border-right:2px solid transparent;
      border-top:16px solid #fffdf5;
      transform:rotate(-8deg);
      transform-origin:top center;
    }
    .aw-annie-guide.left .aw-annie-bubble::before{
      left:32px;
      bottom:-20px;
    ...
    .aw-annie-guide.left .aw-annie-bubble::after{
      left:33px;
      bottom:-15px;
    ...
    html body .hero.aw-hero .aw-kicker{
      ...
      text-shadow:0 2px 2px rgba(2,11,8,.98),0 0 8px rgba(0,0,0,.9)!important;
      -webkit-text-stroke:.35px rgba(4,20,14,.9);
    ...
    @media(max-width:700px){
      ...
      .aw-annie-guide{width:172px;height:130px;bottom:116px}
      .aw-annie-trunk-mask{width:14px}
      .aw-annie-button{width:82px}
      .aw-annie-bubble{bottom:79px;width:122px;min-height:40px;padding:6px 9px;font-size:9.7px}
      .aw-annie-bubble.long{width:144px;min-height:46px;padding:7px 10px;font-size:9.9px}
      html body .hero.aw-hero .aw-kicker{font-size:clamp(.7rem,3.1vw,.84rem)!important;letter-spacing:.055em!important}
    }

    @media(prefers-reduced-motion:reduce){
      .aw-annie-guide,.aw-annie-button,.aw-annie-bubble{transition:none!important}
    }
  `;
