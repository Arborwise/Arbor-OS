(() => {
  ...
  document.getElementById('arborwise-annie-way-v40')?.remove();

  const style = document.createElement('style');
  style.id = 'arborwise-annie-way-v40';
  style.textContent = `
    /* Arborwise Way: compact, high-contrast cards with distinct accents. */
    ...
    html body .way-section .process>li>div{
    ...
    /* Annie already includes her own branch: remove the duplicate generated perch. */
    .aw-v39-guide .aw-v39-perch{display:none!important}
    .aw-v39-guide{width:194px!important;height:126px!important}
    .aw-v39-guide.right .aw-v39-annie{right:-2px!important;bottom:6px!important}
    .aw-v39-guide.left .aw-v39-annie{left:-2px!important;bottom:6px!important}

    /* Match the full-height edge trunks to Annie's existing branch palette. */
    .aw-v39-edge,
    .aw-v39-guide .aw-v39-trunk-mask{
      opacity:1!important;
      background:
        repeating-linear-gradient(97deg,transparent 0 4px,rgba(24,10,5,.66) 5px 8px,transparent 9px 14px),
        repeating-linear-gradient(83deg,rgba(205,157,108,.11) 0 2px,transparent 3px 11px),
        linear-gradient(90deg,#29170e 0%,#593921 34%,#8a6243 52%,#593921 70%,#29170e 100%)!important;
      box-shadow:inset 0 0 7px rgba(20,8,4,.75),0 0 8px rgba(0,0,0,.58)!important;
    }
    .aw-v39-edge{width:24px!important}
    .aw-v39-guide .aw-v39-trunk-mask{width:26px!important;z-index:8!important}
    ...
    @media(max-width:700px){
      ...
      html body .way-section .process>li h3{
        font-size:clamp(1.14rem,5.6vw,1.45rem)!important;
      }
      html body .way-section .process>li p{
